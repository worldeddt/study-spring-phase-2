...
G_DEFINE_TYPE_WITH_PRIVATE (KmsSdpMidExt, kms_sdp_mid_ext,
                                G_TYPE_OBJECT)
...
kms_sdp_mid_ext_class_init (KmsSdpMidExtClass * klass)
{
  ...
  g_type_interface_add_prerequisite (KMS_TYPE_SDP_MID_EXT, KMS_TYPE_I_SDP_MEDIA_EXTENSION);
      g_type_add_interface_static (KMS_TYPE_SDP_MID_EXT, KMS_TYPE_I_SDP_MEDIA_EXTENSION,
                                   &(const GInterfaceInfo) {
                                       (GInterfaceInitFunc) kms_i_sdp_media_extension_init,
                                       NULL,
                                       NULL
                                   });
}
...
//  self->priv = KMS_SDP_MID_EXT_GET_PRIVATE (self);
    self->priv = kms_sdp_mid_ext_get_instance_private (self);
  /* Nothing to do */
}
