...
G_DEFINE_TYPE_WITH_PRIVATE (KmsImageOverlay, kms_image_overlay, GST_TYPE_VIDEO_FILTER);
...
//   imageoverlay->priv = G_TYPE_INSTANCE_GET_PRIVATE (
//           (imageoverlay),
//           KMS_TYPE_IMAGE_OVERLAY,
//           KmsImageOverlayPrivate
//    );

  imageoverlay->priv = kms_image_overlay_get_instance_private(imageoverlay);
