...
G_DEFINE_TYPE_WITH_PRIVATE (KmsVp8Parse, kms_vp8_parse, GST_TYPE_BASE_PARSE);
...
//  vp8parse->priv = G_TYPE_INSTANCE_GET_PRIVATE (
//      (vp8parse),
//      KMS_TYPE_VP8_PARSE,
//      KmsVp8ParsePrivate
//    );

  vp8parse->priv = kms_vp8_parse_get_instance_private(vp8parse);
}
