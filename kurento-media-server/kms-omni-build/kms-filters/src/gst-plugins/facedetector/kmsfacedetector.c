...
G_DEFINE_TYPE_WITH_PRIVATE (KmsFaceDetector, kms_face_detector, GST_TYPE_VIDEO_FILTER);
...
//  facedetector->priv = G_TYPE_INSTANCE_GET_PRIVATE (
//      (facedetector),
//      KMS_TYPE_FACE_DETECTOR,
//      KmsFaceDetectorPrivate
//    );

  facedetector->priv = kms_face_detector_get_instance_private(facedetector);
