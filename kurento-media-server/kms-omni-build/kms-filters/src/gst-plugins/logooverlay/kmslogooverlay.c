...
G_DEFINE_TYPE_WITH_PRIVATE(KmsLogoOverlay, kms_logo_overlay, GST_TYPE_VIDEO_FILTER);
...
//  logooverlay->priv = KMS_LOGO_OVERLAY_GET_PRIVATE (logooverlay);
  ...
  logooverlay->priv = kms_logo_overlay_get_instance_private(logooverlay);

//  logooverlay->priv = G_TYPE_INSTANCE_GET_PRIVATE (
//      (logooverlay),
//      KMS_TYPE_LOGO_OVERLAY,
//      KmsLogoOverlayPrivate
//    );
